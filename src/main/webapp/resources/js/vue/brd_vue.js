...
brd_vue = {
		...
		brd_body: ()=>{
			    				...
			    				'      <a class="navbar-brand" href="#"><i class="fab fa-angellist fa-3x"></i></a>'+
			    				...
			    				'    <h6 class="border-bottom border-gray pb-2 mb-0">최근 글 보기</h6>'+
			    				'    <div class="media text-muted pt-3">'+
			    				      '<svg class="bd-placeholder-img mr-2 rounded" width="32" height="32" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice" focusable="false" role="img" aria-label="Placeholder: 32x32"><title>Placeholder</title><rect width="100%" height="100%" fill="#007bff"></rect><text x="50%" y="50%" fill="#007bff" dy=".3em">32x32</text></svg>'+
			    				'      <p class="media-body pb-3 mb-0 small lh-125 border-bottom border-gray">'+
			    				'        <strong class="d-block text-gray-dark">@username1</strong>'+
			    				        'username1'+
			    				'      </p>'+
			    				'    </div>'+
			    				'    <div class="media text-muted pt-3">'+
			    				...
			    				'      <p class="media-body pb-3 mb-0 small lh-125 border-bottom border-gray">'+
			    				'        <strong class="d-block text-gray-dark">@username2</strong>'+
			    				        '@username2'+
			    				'      </p>'+
			    				'    </div>'+
			    				'    <div class="media text-muted pt-3">'+
			    				...
			    				'      <p class="media-body pb-3 mb-0 small lh-125 border-bottom border-gray">'+
			    				'        <strong class="d-block text-gray-dark">@username3</strong>'+
			    				        '@username3'+
			    				'      </p>'+
			    				'    </div>'+
...
//			+'<input type="text" name="writer" style="margin-top:20px" class="form-control" placeholder="작성자 이름" />'
			+'<input id="scid" class="form-control"/>'
